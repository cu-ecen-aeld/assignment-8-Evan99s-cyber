...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-neginmadani-1.git;protocol=ssh;branch=main"

PV = "1.0+git${SRCPV}"
# set to reference a specific commit hash in your assignment repo
SRCREV = "7342fe2bf976cd99046acfcad8766de33d305adb"
